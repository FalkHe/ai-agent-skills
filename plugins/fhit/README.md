...
- `skills/` — commands `init intent issue backlog refine sprint status`; knowledge `workflow git-flow github gitlab docs-lookup browser-check laravel fastapi typer react-next vue tailwind mui docker-dev`
